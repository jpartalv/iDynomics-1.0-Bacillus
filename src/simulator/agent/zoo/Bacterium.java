...
public class Bacterium extends LocatedAgent implements Cloneable {
	...
	/**
	 * @uml.property  name="_inertSpecies"
	 * @uml.associationEnd  
	 */
	protected Species         _inertSpecies;
	/**
	 * @uml.property  name="_epsSpecies"
	 * @uml.associationEnd  
	 */
	...
	public void mutatePop() {
		...
		for (int i = 0; i<particleMass.length; i++) {
			particleMass[i] = ExtraMath.deviateFrom(particleMass[i], getSpeciesParam().initialMassCV);
		}
	}
