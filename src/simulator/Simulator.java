...
public class Simulator {
	...
	/**
	 * @uml.property  name="povRayWriter"
	 * @uml.associationEnd  
	 */
	...
	/**
	 * @uml.property  name="soluteList"
	 * @uml.associationEnd  multiplicity="(0 -1)"
	 */
	public SoluteGrid[]           soluteList;
	/**
	 * @uml.property  name="reactionList"
	 * @uml.associationEnd  multiplicity="(0 -1)"
	 */
	public Reaction[]             reactionList;
	/**
	 * @uml.property  name="solverList"
	 * @uml.associationEnd  multiplicity="(0 -1)"
	 */
	...
	/**
	 * @uml.property  name="agentGrid"
	 * @uml.associationEnd  
	 */
	public AgentContainer         agentGrid;

	/**
	 * @uml.property  name="_graphics"
	 * @uml.associationEnd  
	 */
