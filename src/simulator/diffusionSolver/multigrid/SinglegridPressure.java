...
/**
 * Project iDynoMiCS (copyright -> see Idynomics.java) _____________________________________________________ Implements static utility functions for used in multigrid method.
 */
...
public class SinglegridPressure {
	...
	/**
	 * @uml.property  name="_conc"
	 * @uml.associationEnd  
	 */
	public SoluteGrid                 _conc;
	/**
	 * @uml.property  name="_reac"
	 * @uml.associationEnd  
	 */
	public SoluteGrid _reac;
	/**
	 * @uml.property  name="_rhs"
	 * @uml.associationEnd  
	 */
	protected SoluteGrid              _rhs;
	/**
	 * @uml.property  name="_itemp"
	 * @uml.associationEnd  
	 */
	protected SoluteGrid _itemp;
	/**
	 * @uml.property  name="_itau"
	 * @uml.associationEnd  
	 */
