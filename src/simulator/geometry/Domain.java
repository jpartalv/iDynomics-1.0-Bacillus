...
public class Domain implements IsComputationDomain {
	...
	/**
	 * @uml.property  name="_domainGrid"
	 * @uml.associationEnd  
	 */
	protected SpatialGrid     _domainGrid;
	/**
	 * @uml.property  name="_boundaryLayer"
	 * @uml.associationEnd  
	 */
	protected SoluteGrid      _boundaryLayer;

	/**
	 * @uml.property  name="_diffusivityGrid"
	 * @uml.associationEnd  
	 */
	protected SoluteGrid _diffusivityGrid;

	/**
	 * @uml.property  name="_biomassGrid"
	 * @uml.associationEnd  
	 */
	protected SoluteGrid _biomassGrid;
