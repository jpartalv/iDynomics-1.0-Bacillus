...
public final class ExtraMath {
	...
	/**
	 * Radius of a capsule with volume v
	 * 
	 * @param v volume
	 * @param r radius
	 * @return length
	 */
	/*public static final double lengthOfACapsule(double v, double r) {
		return (double) ((0.23873d * v / (Math.PI * Math.pow(r, 2))) - (1.33333d * r));
	}*/
	
	/**
	 * Radius of a sphere with volume v and radius r
	 * 
	 * @param v volume
	 * @return radius
	 */
